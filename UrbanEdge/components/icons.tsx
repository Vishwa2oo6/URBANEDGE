...
export const ChevronDownIcon: React.FC<IconProps> = ({
  ...
  <svg className={className} fill="currentColor" aria-hidden="true" viewBox="0 0 20 20">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const UpiIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 11V3M12 11l-4 4M12 11l4 4M5 21h14" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16v-2a2 2 0 00-2-2H9a2 2 0 00-2 2v2" />
  </svg>
);

export const CodIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V7a2 2 0 00-2-2H9a2 2 0 00-2 2v2m10 8V11a2 2 0 00-2-2H9a2 2 0 00-2 2v6m10 0a2 2 0 01-2 2H9a2 2 0 01-2-2m10 0H7" />
...
export const TruckIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17a2 2 0 10-4 0 2 2 0 004 0zm10 0a2 2 0 10-4 0 2 2 0 004 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 8H5a2 2 0 00-2 2v4h16v-4a2 2 0 00-2-2zM3 14V6a2 2 0 012-2h12l4 4v4h-2z" />
  </svg>
);
...
export const StoreIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-3 3v8" />
  </svg>
);
